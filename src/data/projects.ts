...
export const experience: ResumeEntry[] = [
  {
    ...
    descriptionIt:
      'Sviluppo di soluzioni software su misura per digitalizzare i processi aziendali. Tra l’altro concezione e sviluppo di uno strumento di onboarding per il deploy europeo nel reparto HR.',
  },
  {
    period: '2018 - 2021',
    title: 'Student Research Assistant',
    titleDe: 'Hilfswissenschaftler',
    titleIt: 'Assistente di ricerca studentesco',
    organization: 'German Aerospace Center (DLR)',
    organizationDe: 'Deutsches Zentrum für Luft- und Raumfahrt e.V.',
    organizationIt: 'Deutsches Zentrum für Luft- und Raumfahrt e.V.',
    ...
    descriptionIt:
      'Sviluppo software e ricerca su una nuova architettura di computer di bordo per veicoli spaziali nell’ambito del progetto ScOSA.',
  },
]
...
export const education: ResumeEntry[] = [
  {
    period: '2024 - Present',
    periodDe: '2024 - Heute',
    periodIt: '2024 - ad oggi',
    title: 'MSc. Architecture',
    titleDe: 'MSc. Architektur',
    titleIt: 'Laurea magistrale in architettura',
  ...
  },
  {
    ...
    titleIt: 'Laurea triennale in architettura',
    organization: 'RWTH Aachen',
    organizationDe: 'RWTH Aachen',
    organizationIt: 'RWTH Aachen',
    logo: resolveAssetUrl('RWTH.svg'),
